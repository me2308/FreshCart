...
export default function Cart() {
  let { cart, getCart , updateProduct, loading , deleteProduct} = useContext(CartContext);
  ...
  return (
    <>
      ...
      : 
        <div>
          <div className="relative overflow-x-auto w-3/4 mx-auto shadow-md sm:rounded-lg py-3 ">
          {loading?<div className="flex justify-center py-20">
          <Loading />
        </div>:<div>
          <Link to={'/checkout'} className="bg-green-500 text-white py-2 px-1 float-end rounded-md">Check Out</Link>
